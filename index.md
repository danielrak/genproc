...
`genproc` turns one-off iterative R procedures (`for`,
...
compares two runs and tells you which referenced files have changed
since the first one:
...
Dispatch cases across workers by passing a
...
Under the hood,
[`parallel_spec()`](https://danielrak.github.io/genproc/reference/parallel_spec.md)
builds a configuration object consumed by
[`future.apply::future_lapply()`](https://future.apply.futureverse.org/reference/future_lapply.html).

If you manage
[`future::plan()`](https://future.futureverse.org/reference/plan.html)
yourself (recommended across several calls to amortize worker startup),
pass
[`parallel_spec()`](https://danielrak.github.io/genproc/reference/parallel_spec.md)
without a strategy and your current plan is used unchanged.
...
Version 0.2.0 is available on CRAN. The development version can be
installed from GitHub (see above).

## Learn more

See
[`vignette("genproc")`](https://danielrak.github.io/genproc/articles/genproc.md)
for a deep dive: anatomy of the log and reproducibility snapshot,
per-case error handling, composition patterns, and roadmap.
