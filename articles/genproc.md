...
#> 1 case_0001 /tmp/RtmpbEf12b/genproc-vignette-src    a.csv
#> 2 case_0002 /tmp/RtmpbEf12b/genproc-vignette-src    b.csv
#> 3 case_0003 /tmp/RtmpbEf12b/genproc-vignette-src    c.csv
#>                                dst_dir dst_file success error_message traceback
#> 1 /tmp/RtmpbEf12b/genproc-vignette-dst    a.rds    TRUE          <NA>      <NA>
#> 2 /tmp/RtmpbEf12b/genproc-vignette-dst    b.rds    TRUE          <NA>      <NA>
#> 3 /tmp/RtmpbEf12b/genproc-vignette-dst    c.rds    TRUE          <NA>      <NA>
#>   duration_secs
#> 1         0.001
#> 2         0.001
#> 3         0.000
...
#> List of 11
#>  $ timestamp    : POSIXct[1:1], format: "2026-07-04 19:44:27"
#>  $ r_version    : chr "R version 4.6.1 (2026-06-24)"
#>  $ platform     : chr "x86_64-pc-linux-gnu"
#>  $ os           : chr "Linux 6.17.0-1018-azure"
...
#>  $ timezone     : chr "UTC"
#>  $ packages     : Named chr [1:34] "0.2.0" "0.6.39" "1.4.3" "2.6.1" ...
#>   ..- attr(*, "names")= chr [1:34] "genproc" "digest" "desc" "R6" ...
...
#>                                         path size               mtime
#> 1 /tmp/RtmpbEf12b/genproc-vignette-src/a.csv  214 2026-07-04 19:44:27
#> 2 /tmp/RtmpbEf12b/genproc-vignette-src/b.csv  296 2026-07-04 19:44:27
#> 3 /tmp/RtmpbEf12b/genproc-vignette-src/c.csv  154 2026-07-04 19:44:27
```
...
#> 
#> Changed files:
#>   /tmp/RtmpbEf12b/genproc-vignette-src/a.csv
#>       size:  214 B -> 3.9 KB
#>       mtime: 2026-07-04 19:44:27 -> 2026-07-04 19:44:27
#> 
...
#> '/tmp/RtmpbEf12b/genproc-vignette-src/b.csv': No such file or directory
...
formals(fn)
#> $param_1
#> [1] "/tmp/RtmpbEf12b/genproc-vignette-src/a.csv"
#> 
#> $param_2
#> [1] "/tmp/RtmpbEf12b/genproc-vignette-dst/a-from-example.rds"
```
