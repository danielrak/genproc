...
#> 1 case_0001 /tmp/Rtmpm8JKRD/genproc-vignette-src    a.csv
#> 2 case_0002 /tmp/Rtmpm8JKRD/genproc-vignette-src    b.csv
#> 3 case_0003 /tmp/Rtmpm8JKRD/genproc-vignette-src    c.csv
#>                                dst_dir dst_file success error_message traceback
#> 1 /tmp/Rtmpm8JKRD/genproc-vignette-dst    a.rds    TRUE          <NA>      <NA>
#> 2 /tmp/Rtmpm8JKRD/genproc-vignette-dst    b.rds    TRUE          <NA>      <NA>
#> 3 /tmp/Rtmpm8JKRD/genproc-vignette-dst    c.rds    TRUE          <NA>      <NA>
#>   duration_secs
#> 1         0.001
#> 2         0.001
#> 3         0.000
...
#> List of 11
#>  $ timestamp    : POSIXct[1:1], format: "2026-05-21 17:20:21"
...
#>                                         path size               mtime
#> 1 /tmp/Rtmpm8JKRD/genproc-vignette-src/a.csv  214 2026-05-21 17:20:21
#> 2 /tmp/Rtmpm8JKRD/genproc-vignette-src/b.csv  296 2026-05-21 17:20:21
#> 3 /tmp/Rtmpm8JKRD/genproc-vignette-src/c.csv  154 2026-05-21 17:20:21
```
...
#> 
#> Changed files:
#>   /tmp/Rtmpm8JKRD/genproc-vignette-src/a.csv
#>       size:  214 B -> 3.9 KB
#>       mtime: 2026-05-21 17:20:21 -> 2026-05-21 17:20:22
#> 
...
#> '/tmp/Rtmpm8JKRD/genproc-vignette-src/b.csv': No such file or directory
...
#>   Success    : 67%
#>   Total time : 0.02s
#>   Per case   : mean 0.001s, max 0.001s (slowest: case_0002)
#> 
#> Top errors:
...
formals(fn)
#> $param_1
#> [1] "/tmp/Rtmpm8JKRD/genproc-vignette-src/a.csv"
#> 
#> $param_2
#> [1] "/tmp/Rtmpm8JKRD/genproc-vignette-dst/a-from-example.rds"
```
