...
#> 1 case_0001 /tmp/RtmpgkJ2sx/genproc-vignette-src    a.csv
#> 2 case_0002 /tmp/RtmpgkJ2sx/genproc-vignette-src    b.csv
#> 3 case_0003 /tmp/RtmpgkJ2sx/genproc-vignette-src    c.csv
#>                                dst_dir dst_file success error_message traceback
#> 1 /tmp/RtmpgkJ2sx/genproc-vignette-dst    a.rds    TRUE          <NA>      <NA>
#> 2 /tmp/RtmpgkJ2sx/genproc-vignette-dst    b.rds    TRUE          <NA>      <NA>
#> 3 /tmp/RtmpgkJ2sx/genproc-vignette-dst    c.rds    TRUE          <NA>      <NA>
#>   duration_secs
#> 1         0.001
#> 2         0.001
#> 3         0.001
...
#> List of 11
#>  $ timestamp    : POSIXct[1:1], format: "2026-05-02 20:13:22"
...
#>                                         path size               mtime
#> 1 /tmp/RtmpgkJ2sx/genproc-vignette-src/a.csv  214 2026-05-02 20:13:22
#> 2 /tmp/RtmpgkJ2sx/genproc-vignette-src/b.csv  296 2026-05-02 20:13:22
#> 3 /tmp/RtmpgkJ2sx/genproc-vignette-src/c.csv  154 2026-05-02 20:13:22
```
...
#> 
#> Changed files:
#>   /tmp/RtmpgkJ2sx/genproc-vignette-src/a.csv
#>       size:  214 B -> 3.9 KB
#>       mtime: 2026-05-02 20:13:22 -> 2026-05-02 20:13:23
#> 
...
#> '/tmp/RtmpgkJ2sx/genproc-vignette-src/b.csv': No such file or directory
...
formals(fn)
#> $param_1
#> [1] "/tmp/RtmpgkJ2sx/genproc-vignette-src/a.csv"
#> 
#> $param_2
#> [1] "/tmp/RtmpgkJ2sx/genproc-vignette-dst/a-from-example.rds"
```
